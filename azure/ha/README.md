...
To be able to automatically make these API calls, the two HA members must be provided with Azure Active Directory credentials (`azure_ha.json`) using the Azure Role-Based Access Control (RBAC).<br>
